...
class TestParzen(unittest.TestCase):
    def test_basic(self):
        np.testing.assert_allclose(_windows._parzen(6),
                                   [0.009259259259259254, 0.25, 0.8611111111111112,
                                    0.8611111111111112, 0.25, 0.009259259259259254])
        np.testing.assert_allclose(_windows._parzen(7),
...
class TestBohman(unittest.TestCase):
    def test_basic(self):
        np.testing.assert_allclose(_windows._bohman(6),
                                   [0, 0.1791238937062839, 0.8343114522576858,
                                    0.8343114522576858, 0.1791238937062838, 0])
        np.testing.assert_allclose(_windows._bohman(7),
...
class TestBlackmanHarris(unittest.TestCase):
    def test_basic(self):
        np.testing.assert_allclose(_windows._blackmanharris(6),
                                   [6.0e-05, 0.1030114893456638, 0.7938335106543362,
                                    0.7938335106543364, 0.1030114893456638, 6.0e-05])
        np.testing.assert_allclose(_windows._blackmanharris(7),
...
class TestFlatTop(unittest.TestCase):
    def test_basic(self):
        np.testing.assert_allclose(_windows._flattop(6),
                                   [-0.000421051, -0.0677142520762119, 0.6068721525762117,
                                    0.6068721525762117, -0.0677142520762119,
                                    -0.000421051])
        np.testing.assert_allclose(_windows._flattop(7),
